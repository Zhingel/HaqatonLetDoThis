...
class SubscribesTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        self.backgroundColor = #colorLiteral(red: 0.6642414927, green: 0.8578526974, blue: 0.9460429549, alpha: 1) //UIColor(named: "SecondaryBackColor")
